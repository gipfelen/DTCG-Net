...
dataset_path=os.path.abspath(os.path.join(BASE_DIR, '../dataset/affordances/'))
...
if __name__ == '__main__':
    d = PartDataset( root='../dataset/affordances/',classification=True, class_choice='Mug', npoints=2048, split='test')
    ps, cls = d[0]
