...
dataset_path=os.path.abspath(os.path.join(BASE_DIR, '../dataset/kitchen-data-subset-recalibrated/'))
...
if __name__ == '__main__':
    d = PartDataset( root='../dataset/kitchen-data-subset_preprocessed/',classification=True, class_choice='Mug', npoints=2048, split='test')
    ps, cls = d[0]
